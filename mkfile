...
AMD_TOOLS = all-any at boolean cat coprime count dedupe div divalg elt filter gcd lcm lcp length leq map max-min minus nat plus power prefix prime range repeat rev select sublist tails-inits times tuple unique unzip zip
