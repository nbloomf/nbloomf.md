...
This post is literate Haskell; you can load [the source](https://raw.githubusercontent.com/nbloomf/nbloomf.md/master/posts/2016-03-01-software-tools-in-haskell-compare.lhs) into GHCi and play along. As usual, we start with some imports.
