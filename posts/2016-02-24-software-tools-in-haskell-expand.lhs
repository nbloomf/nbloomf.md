...
This post is literate Haskell; you can load [the source](https://raw.githubusercontent.com/nbloomf/nbloomf.md/master/posts/2016-02-24-software-tools-in-haskell-expand.lhs) into GHCi and play along. As usual, we start with some imports.
