...
This post is literate Haskell; you can load [the source](https://raw.githubusercontent.com/nbloomf/nbloomf.md/master/posts/2016-02-16-software-tools-in-haskell-charcombine.lhs) into GHCi and play along. As usual, we start with some imports.
...
Since we already have a function, [``getGlyphs``](/posts/2016-02-14-software-tools-in-haskell-glyphcount.html), which splits a stream of characters into noncombining+combining substrings, the main function of ``charcombine`` is quite succinct.
